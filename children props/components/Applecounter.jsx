...
//console.log(typeof Fragment)// symbol
...
const Applecounter = () => {
  ...
  const [leftapplecount, setrightapplecount] = useState(
    totalapplecount - rightapplecount
  );

  const rightClickHandler = () => {
    // onclick = {() =>{console('click me') }}
    // console.log("right");
  ...
  return (
    // we can also use this ae well <>  </>
    <section>
      <ApplrBasket applecount={leftapplecount} basketname="basket 1" />
      <Button clickHandler={leftClickHandler} imageUrl={image1} buttonName="left arrow">
        left arrow
      </Button>
